...
from scrapy_patchwright.headers import use_scrapy_headers
from scrapy_patchwright.page import PageMethod
from scrapy_patchwright._utils import (
...
logger = logging.getLogger("scrapy-patchwright")
